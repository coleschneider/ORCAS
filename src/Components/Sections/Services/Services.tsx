  ...
  <ServicesWrapper>
    <div className="row services block-1-3 block-m-1-2">
      <ServiceItem icon="icon-heart" title="Giving">
        Nemo cupiditate ab quibusdam quaerat impedit magni. Earum suscipit ipsum laudantium. Quo delectus est. Maiores
        voluptas ab sit natus veritatis ut. Debitis nulla cumque veritatis. Sunt suscipit voluptas ipsa in tempora esse
        soluta sint.
      </ServiceItem>
